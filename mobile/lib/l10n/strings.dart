class S {
  ...
  // ── Time window ─────────────────────────────────────
  String get attendanceWindow => isArabic ? 'نافذة الحضور' : 'Attendance Window';
  ...
  String countdown(int hours, int minutes) => isArabic
      ? '$hours س $minutes د'
      : '${hours}h ${minutes}m';
  ...
  String windowCloses(int minutes) =>
      isArabic ? 'تُغلق النافذة خلال $minutes دقيقة' : 'Window closes in $minutes min';
  ...
  String farAwayDistance(int meters) =>
      isArabic ? 'أنت بعيد $meters متر عن سكنك' : 'You are ${meters}m away from your dorm';
  ...
  String get seeYouTomorrow =>
      isArabic ? 'نراك غدًا!' : 'See you tomorrow!';
  ...
  String get debugTitle =>
      isArabic ? 'أدوات الاختبار' : 'Debug Controls';
  String get debugBeforeWindow =>
      isArabic ? 'قبل الوقت' : 'Before window';
  String get debugNearby =>
      isArabic ? 'قريب + متاح' : 'Nearby + Open';
  String get debugFarAway =>
      isArabic ? 'بعيد + متاح' : 'Far away + Open';
  String get debugMock =>
      isArabic ? 'موقع وهمي' : 'Mock location';
  String get debugClosed =>
      isArabic ? 'انتهى الوقت' : 'Window closed';
  String get debugCheckedIn =>
      isArabic ? 'تم الحضور' : 'Checked in';
