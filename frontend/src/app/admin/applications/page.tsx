                  ...
                  <React.Fragment key={app.app_id}>
                    <tr className="hover:bg-surface-container-lowest/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div 
                          className="font-bold text-primary cursor-pointer hover:underline inline-block"
                          onClick={(e) => {
                            e.stopPropagation();
                            router.push(`/admin/students?id=${app.student_id}`);
                          }}
                        >
                          {app.student_name}
                        </div>
                        ...
                        <td colSpan={5} className="px-6 py-6 border-l-4 border-primary">
                          <div className="max-w-3xl space-y-4">
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                              ...
                              {app.latest_doc_id && (
                                <button
                                  onClick={() => router.push(`/admin/verifications/${app.latest_doc_id}`)}
                                  className="bg-blue-50 text-primary px-4 py-2 rounded-lg text-sm font-bold hover:bg-blue-100 transition-colors flex items-center gap-1"
                                >
                                  <span className="material-symbols-outlined text-[16px]">verified_user</span> View Verification
                                </button>
                              )}
